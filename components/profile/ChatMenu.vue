...
export default {
  ...
  methods: {
    ...
    async fetchCoachId() {
      try {
        const res = await fetch(`/api/clients/${this.user.clientid}/coach`);
    ...
    async fetchMessages() {
      ...
      try {
        const res = await fetch(`/api/chat?senderId=${this.userId}&recipientId=${this.recipientId}`);
    ...
    async fetchClients() {
      try {
        const res = await fetch(`/api/coaches/${this.user.coachid}/clients`);
